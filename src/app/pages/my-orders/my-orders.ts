...
<!--                    </div>-->
                ...
                <ng-template #header>
                    <tr>
                        ...
                        <th pSortableColumn="name">Наименование <p-sortIcon field="name" /></th>
                        <th></th>
                        <th pSortableColumn="price">Цена <p-sortIcon field="price" /></th>
                        <th pSortableColumn="category">Категория <p-sortIcon field="category" /></th>
<!--                        <th pSortableColumn="rating">Reviews <p-sortIcon field="rating" /></th>-->
                        <th pSortableColumn="inventoryStatus">Статус <p-sortIcon field="inventoryStatus" /></th>
                    </tr>
                </ng-template>
                        ...
                        <td colspan="7">
                            <div class="p-4">
                                ...
                                <p-table stripedRows  [value]="product.orders" dataKey="id">
                                    <ng-template #header>
                                        <tr>
                                            <th pSortableColumn="description">Описание <p-sortIcon field="description" /></th>
                                            <th pSortableColumn="customer">Клиент <p-sortIcon field="customer" /></th>
                                            <th pSortableColumn="date">Дата <p-sortIcon field="date" /></th>
                                            <th pSortableColumn="amount">Кол-во в шт <p-sortIcon field="amount" /></th>
...
export class MyOrders {
    ...
    expandAll() {
        this.expandedRows = this.products.reduce((acc: { [key: string]: boolean }, p: any) => {
            acc[p.id] = true;
            return acc;
        }, {});
    }
    ...
    getStatusSeverity(status: any) {
        switch (status) {
            ...
            case 'ОТМЕНЕН':
                return 'danger';
            default:
                return 'info'; // или любое значение по умолчанию
        }
    }
